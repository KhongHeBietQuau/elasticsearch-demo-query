...
public class ElasticSearchController {
    ...
    @GetMapping("/searchDocumentMetricFile")
    public ResponseEntity<Object> searchAllDocumentFileMetric() throws IOException {
        List<Object> products = Collections.singletonList(elasticSearchQuery.searchAllDocumentMetricFile());
        return new ResponseEntity<>(products, HttpStatus.OK);
    }
